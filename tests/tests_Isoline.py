...
# expected
points_out = [
    [-15.1, 4.0], [-12.9429, 2.9388], [-10.7857, 2.0408], [-8.6286, 1.3061], 
    [-6.4714, 0.7347], [-4.3143, 0.3265], [-2.1571, 0.0816], [0.0, 0.0], 
    [2.1571, 0.0816], [4.3143, 0.3265], [6.4714, 0.7347], [8.6286, 1.3061], 
    [10.7857, 2.0408], [12.9429, 2.9388], [15.1, 4.0]
]
...
class TestsIsoline(unittest.TestCase):
    def test_isoline_initialization(self: Self) -> None:
        ...
        self.assertEqual(isoline.cl_pt_ref, cl_point, "Isoline reference ClPoint was not correctly set.")
        self.assertEqual(isoline.isoline_type, IsolineType.CHANNEL, "Isoline type was not correctly set.")
        self.assertEqual(len(isoline.points), 0, "Isoline point list was not correctly set.")
    ...
    def test_channel_cross_section_initialization(self: Self) -> None:
        ...
        self.assertEqual(channel_cs.age, age1, "Channel cross-section age was not correctly set.")
        self.assertEqual(channel_cs.cl_pt_ref, cl_point, "Channel cross-section reference ClPoint was not correctly set.")
        self.assertEqual(channel_cs.isoline_type, IsolineType.CHANNEL, "Channel cross-section type was not correctly set.")
        self.assertEqual(len(channel_cs.points), 0, "Channel cross-section point list was not correctly set.")
    ...
    def test_complete_channel_shape(self: Self) -> None:
        ...
        self.assertEqual(len(channel_cs.points), nb_pts, "Channel cross-section number of points is wrong.")
        ...
        self.assertSequenceEqual(points_obs, points_out, "Channel cross-section list of points is wrong.")
